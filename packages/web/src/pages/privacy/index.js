...
const Privacy = ({ location, classes }) => (
  <React.Fragment>
    <Helmet
      {...getMetaTags({
        title: `Privacy Policy - Pesposa`,
    ...
    <Layout header={Header} fixed>
      <div className={classes.root}>
        ...
        <Section paragraph>
          ...
          tools in the future.
          <br />
          We use cookies to understand and save user&apos;s preferences for
          future visits.
        </Section>
        <Section paragraph>
        ...
        <Section paragraph>
          ...
          to you using the Google Ad Settings page. Alternatively, you can opt
          out by visiting the Network Advertising Initiative Opt Out page or by
