...
const priceReducer = handleActions(
  {
    ...
    [types.SET_SELLER]: (state, { payload }) =>
      R.assoc(constants.SELLER_KEY, payload, state),
    ...
    [types.RESET_SELLER]: state =>
      R.assoc(constants.SELLER_KEY, initialState[constants.SELLER_KEY], state),
