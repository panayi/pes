...
const searchReducers = {
  [constants.HOME_SEARCH_ID]: combineReducers({
    [constants.ROOT_KEY]: multireducer(searchReducer, constants.HOME_SEARCH_ID),
  }),
  [constants.USER_FAVORITES_SEARCH_ID]: combineReducers({
    [constants.ROOT_KEY]: multireducer(
      searchReducer,
      constants.USER_FAVORITES_SEARCH_ID,
    ),
  }),
  [constants.RELATED_ADS_SEARCH_ID]: combineReducers({
    [constants.ROOT_KEY]: multireducer(
      searchReducer,
