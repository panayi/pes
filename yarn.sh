...
# Example:
# DEPLOYMENT=development ./yarn deploy
...
TARGET_ENV_PATH="$BASE_PATH/packages/client/web/.env"
BACKUP_ENV_PATH="$BASE_PATH/packages/client/web/.env.backup"
...
TARGET_SERVICE_ACCOUNT_KEY_PATH="$BASE_PATH/packages/core/src/config/serviceAccountKey.json"
BACKUP_SERVICE_ACCOUNT_KEY_PATH="$BASE_PATH/packages/core/src/config/serviceAccountKey.json.backup"
